<template>
  <article class="bg-white rounded-lg border border-gray-200 hover:border-gray-300 hover:shadow-sm transition-all">
    <NuxtLink :to="`/articles/${article.id}`" class="block p-4">
      <div class="flex items-start space-x-4">
        ...
        <div
          v-else
          class="flex-shrink-0 w-16 h-16 bg-gradient-to-br from-blue-500 to-purple-600 rounded-lg flex items-center justify-center"
        >
        ...
        <div class="flex-1 min-w-0">
          <!-- Title -->
          <h3 class="text-base font-semibold text-gray-900 hover:text-blue-600 transition-colors mb-1 line-clamp-2">
            {{ article.title }}
          </h3>
          ...
          <!-- Tags -->
          <div v-if="article.tags && article.tags.length > 0" class="flex flex-wrap gap-1 mt-2">
            <span
